...
Item {
    ...
    Column {
        ...
        // Sender name (shown above bubble for non-own messages)
        Text {
            visible: bubble.showSenderName && !bubble.isMine
            text: bubble.senderName
            font.pixelSize: 12
            color: "#888"
            leftPadding: 44  // align with bubble text (avatar width + spacing)
        }
