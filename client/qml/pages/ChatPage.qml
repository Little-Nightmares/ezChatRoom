...
Page {
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    color: appCore.themeManager.headerBg
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            font.pixelSize: 18
                            font.bold: true
                            color: appCore.themeManager.headerText
                            Layout.fillWidth: true
                        ...
                        Button {
                            ...
                            background: Rectangle {
                                radius: 4
                                color: friendReqBtn.hovered ? appCore.themeManager.primaryLight : "transparent"
                            }
                        ...
                        Button {
                            ...
                            background: Rectangle {
                                radius: 4
                                color: settingsBtn.hovered ? appCore.themeManager.primaryLight : "transparent"
                            }
                            ...
                            delegate: Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        ...
                                        appCore.groupController.setCurrentGroup(delegateGroupId)
                                        Qt.callLater(function() { loadingMessages = false })
                                    }
                                }
                            }
        ...
        Rectangle {
            ...
            // Chat background (customizable)
            Image {
                anchors.fill: parent
                source: appCore.chatBackground
                fillMode: Image.PreserveAspectCrop
                opacity: 0.2
                sourceSize.width: parent.width
                sourceSize.height: parent.height
                visible: appCore.chatBackground.length > 0
            }
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Column {
                            ...
                            // Online status for private chat
                            StyledText {
                                visible: !appCore.chatController.isInGroupChat && appCore.chatController.currentChatFriendId !== 0
                                text: appCore.friendController.isFriendOnline(appCore.chatController.currentChatFriendId)
                                      ? "\u25CF \u5728\u7EBF" : "\u25CB \u79BB\u7EBF"
                                font.pixelSize: 10
                                color: appCore.friendController.isFriendOnline(appCore.chatController.currentChatFriendId)
                                       ? "#52c41a" : "#999"
                            }
                        }
                        ...
                        TextField {
                            ...
                            onAccepted: {
                                if (text.trim().length > 0) {
                                    ...
                                    // Will call ChatController when search handler is implemented on client
                                    appCore.chatController.searchMessages(text.trim())
                                }
                            }

                            onTextChanged: {
                                if (text.isEmpty()) {
                                    appCore.chatController.clearSearch()
                                }
                            }
                        }
